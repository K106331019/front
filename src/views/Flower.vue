...
<div class="content-all">
  <b-row class="w-100 mt-5 mt-sm-5 pt-sm-5">
    <b-col class="mx-auto d-flex justify-content-start " lg="3" sm="12" md="12">
      <b-list-group class="w-25 d-flex justify-content-start flex-lg-column mx-lg-auto mx-md-auto mt-5 mt-lg-0" horizontal>
    ...
    <b-col class="d-flex pl-4 d-flex justify-content-center" lg="9" sm="12" md="12">
      <b-row class="w-100 mx-auto mt-sm-5 mt-lg-0">
        <b-col sm="12" lg="8" md="6">
          <img src="../assets/image/flower.jpg" width="900" class="flower-title-img">
        </b-col>
        <b-col sm="12" lg="4" md="6" class="my-lg-auto mt-sm-5">
